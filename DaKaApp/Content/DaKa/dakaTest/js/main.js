...
//   $.ajax({
//              type: 'post',
//              url: '/DaKa/DaKaHome/change',
//              cache: false,
//              dataType: "text", //返回数据形式为json
//              data: 'xy=116.286792,39.817852',
//              beforeSend: function () {
//              },
...
function rcsOptimizeReady() {
    ...
    if (window.WebContainer != null) {
        //alert('window.WebContainer is ok');
        //if (window.WebContainer.setAppTitle != null) {
        //    window.WebContainer.setAppTitle('hello');
        //}
        //else {
        //    alert('setAppTitle is null');
        //}
        //if (window.WebContainer.forSetTime != null) {
        //    window.WebContainer.forSetTime('date', 'aspire', 'getDate')
        //}
        //else {
        //    alert('window.WebContainer.forSetTime is null');
        //}

        //if (window.WebContainer.rcsMsgFwd == null) { alert('rcsMsgFwd is null'); }
        //else {
        //    window.WebContainer.rcsMsgFwd({ type: '1', msg: 'hello', backId: 'aspire', backFunc: 'sendmsg' });
        //}

        //if (window.WebContainer.getRcsGroups == null) { alert('getRcsGroups is null'); }
        //else {
        //    window.WebContainer.getRcsGroups({ backId: 'aspire', backFunc: 'window.RCS.cb.getgroup' });
        //}


        if (window.WebContainer.rcsGetCurrentLocation == null) { alert('rcsGetCurrentLocation is null'); }
        else {
        ...
        //alert('window.Webcontainer is null');
    }
    //if (navigator.WebContainer != null) {
    //    navigator.WebContainer.rcsGetCurrentLocation({
    //        backId: 'aspire', backFunc: 'getLocation'
    //    });
    //}
    //else {
    //    alert('navigator.Webcontainer is null');
    //}
}
...
function selecDakaJlu() {
    $.ajax({
        type: 'post',
        url: '/DaKa/DaKaHome/selectDaKaJiLuRcs',
        cache: false,
