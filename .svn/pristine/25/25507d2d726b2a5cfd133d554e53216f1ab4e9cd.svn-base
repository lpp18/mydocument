...
require(["jquery", "swiper.jquery.min", "record"], function ($, Swiper, record) {
        ...
        onTouchEnd: function (swiper) {
            ...
            if (mySwiper2.activeIndex == 1) {
                ...
                if (!$("#DocumentInfo").attr("num")) {
                    ...
                    if (!$("#DocumentInfo .list-group-item").length && fade2) {
    ...
    var TabPosition = record.isshow;  //0选项卡为电子流，1为公文
    ...
    $("#Search").on("focus", function () {
        ...
        if (TabPosition == 0) {
            if ($(this).val() == "") {
                $(".sfind").show("swing");
                $(".swiper-container").hide(0)
            }
        };
    }).on("blur", function () {
       
        $(".sfind").hide(600, "swing");
            ...
            success: function (data) {
                ...
                if (data.length > 0) {
                    ...
                    for (var item in data) {
                        ...
                        HtmlStr += "<div class=\"gcolor Workflow\"><span>" + ProcessName + "，" + Total + "条</span></div>" +
                ...
                $("#QuickLook .Workflow span").on("click", function (e) {
                    var ModelId = $(this).parent().next().val();
                    var Total = $(this).parent().next().next().val();
                    var ProcessName = $(this).parent().next().next().next().val();
